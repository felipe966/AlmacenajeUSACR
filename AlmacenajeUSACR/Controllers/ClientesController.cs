...
namespace AlmacenajeUSACR.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Codigo_cliente,Nombre_completo,Numero_identificacion,Fecha_nacimiento")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Codigo_cliente,Nombre_completo,Numero_identificacion,Fecha_nacimiento")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
